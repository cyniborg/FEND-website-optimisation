...
//getting the correct vendor prefix for transform property
...
// Creating the tranform prefix array
...
var resizePizzas = function(size) {
  ...
  changeSliderLabel(size);
   ...
   // Removed the determineDX function as it was not needed and was creating an extra call.
...
var pizzasDiv = document.getElementById("randomPizzas"); //this had no need to be in the loop.
for (var i = 2; i < 100; i++) {
...
function updatePositions() {
  ...
  for (var i = 0, len=items.length; i < len; i++) {
    // var phase = (Math.sin(number1 + (i % 5)) * (Math.random()+480));
    var phase = (Math.sin(number1 + (i % 5))) * (Math.random()+500);
